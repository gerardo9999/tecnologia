                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="date" v-model="buscar" @keyup.enter="listarReserva(1,buscar,criterio)" id="texto" name="texto" class="form-control" placeholder="Texto a buscar">
    ...
    export default {
        ...
        methods : {
            ...
            listarReserva (page,buscar,criterio){
                let me=this;
                var url= '/reservaCliente?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            guardarReserva(){
                ...
                let me = this;
                let url  = '/reserva/cliente/guardar';
            ...
            actualizarReserva(){
               if (this.validarReserva()){
                ...
                let url    = '/reserva/cliente/modificar';
                let me = this;
